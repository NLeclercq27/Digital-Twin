...
class WaterHeaterPool():
    ...
    def create_WH(self, params): 
        ...
        """
        # Model creation
        WH = wh.procF.WaterHeater(Model = params['model'], Volume = params['volume'], Height = params['height'], Diameter = params['diameter'], EWH = params['EWH'], HPWH = params['HPWH'], double = params['double'])    
    ...
    def save_results_csv(self, name):
        name = wh.procF.file_name_csv(name)
        # create dataframe         
        data = {
